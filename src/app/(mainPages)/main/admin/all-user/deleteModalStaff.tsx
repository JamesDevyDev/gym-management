...
const DeleteModalStaff = ({ member, onSuccess }: DeleteModalProps) => {
    const { deleteStaff } = useAdminStore();  // FIX 1: Added () to call the hook
    ...
    const handleDelete = async () => {
        ...
        try {
            // FIX 2: Pass member._id as selectedId to match API
            const data = await deleteStaff(member._id);
            ...
            toast.error(error.message || "An error occurred while deleting staff");
        } finally {
            setIsSaving(false);
        }
    };
                        ...
                        <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                            <div className="space-y-2 text-sm">
                                <p className="text-gray-600">
                                    <span className="font-medium text-gray-900">Username:</span> {member.username}
                                </p>
...
export default DeleteModalStaff;
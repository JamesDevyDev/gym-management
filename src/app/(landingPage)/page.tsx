                ...
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            <a
                                href="/auth/login"
                                className="bg-red-400 hover:bg-red-500 text-white px-6 py-2 rounded-lg font-semibold transition shadow-lg shadow-red-400/30"
                            >
                                Login
                            </a>
                        </div>
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden bg-white border-t border-gray-200 shadow-lg">
                        <div className="flex flex-col gap-4 px-6 py-4">
                            <a
                                href="/auth/login"
                                className="bg-red-400 hover:bg-red-500 text-center text-white px-6 py-2 rounded-lg font-semibold transition shadow-lg shadow-red-400/30"
                            >
                                Login
                            </a>
                        </div>
            ...
            <section className="py-20 px-6 bg-gradient-to-br from-red-50 to-white">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {/* Registered Users */}
                        <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 border-red-500">
                            ...
                            <div className="text-center">
                                <div className="text-5xl font-bold text-black-400 mb-2">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {plans.map((plan, idx) => (
                            <div
                                key={idx}
                                className={`bg-white rounded-2xl border p-8 transition-all duration-300 hover:scale-105 shadow-lg ${plan.popular ? 'border-red-500 ring-2 ring-red-500 relative' : 'border-gray-200'
                                    }`}
                            >
                                {plan.popular && (
            ...
            <section className="py-20 px-6 bg-gradient-to-br from-red-50 to-white">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="bg-gradient-to-r from-red-500 to-red-400 rounded-3xl p-12 shadow-2xl">
                        ...
                        <a
                            href="/auth/register"
                            className="bg-white hover:bg-gray-50 text-red-400 px-10 py-4 rounded-lg font-semibold text-lg transition transform hover:scale-105 shadow-xl"
                        >
                            Register Now!
                        </a>
                    </div>
